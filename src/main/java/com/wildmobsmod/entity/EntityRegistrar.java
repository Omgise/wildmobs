...
public class EntityRegistrar {
    ...
    public static EntityRegistrar constructDisjunct(Class entityClass, EntityConfig config, String entityName,
        int entityId, int trackingRange, int updateFrequency, boolean sendsVelocityUpdates,
        EnumCreatureType creatureType, BiomeDictionary.Type... biomeTypes) {
        return construct(
            entityClass,
            config,
            entityName,
            ...
            creatureType,
            getBiomesFromTypesDisjunct(biomeTypes));
    }

    public static EntityRegistrar constructConjunct(Class entityClass, EntityConfig config, String entityName,
        int entityId, int trackingRange, int updateFrequency, boolean sendsVelocityUpdates,
        EnumCreatureType creatureType, BiomeDictionary.Type... biomeTypes) {
        return construct(
            entityClass,
            ...
            sendsVelocityUpdates,
            creatureType,
            getBiomesFromTypesConjunct(biomeTypes));
    }

    public static EntityRegistrar construct(Class entityClass, EntityConfig config, String entityName, int entityId,
        int trackingRange, int updateFrequency, boolean sendsVelocityUpdates, EnumCreatureType creatureType,
    ...
    public static EntityRegistrar construct(Class entityClass, EntityConfig config, String entityName, int entityId,
        int trackingRange, int updateFrequency, boolean sendsVelocityUpdates, EnumCreatureType creatureType,
        BiomeGenBase[] biomes) {
        EntityRegistrar registrar = new EntityRegistrar(
            entityClass,
            config,
            entityName,
            entityId,
    ...
    protected EntityRegistrar(Class entityClass, EntityConfig config, String entityName, int entityId,
        int trackingRange, int updateFrequency, boolean sendsVelocityUpdates, EnumCreatureType creatureType,
        BiomeGenBase[] biomes) {
    ...
    protected void registerSpawns() {
        ...
        if (spawnrate > 0 && biomes != null && biomes.length > 0) {
            EntityRegistry.addSpawn(
                entityClass,
                spawnrate,
                config.getMinPackSize(),
                config.getMaxPackSize(),
                creatureType,
                biomes);
        }
    }
