...
public class EntityAIAdultAttackOnCollide extends EntityAIBase {
    ...
    public EntityAIAdultAttackOnCollide(EntityAgeable attacker, Class targetClass, double runningSpeed,
        boolean rememberLong) {
    ...
    public boolean shouldExecute() {
        ...
        if (entitylivingbase == null) {
            ...
            if (--this.initiative <= 0) {
                ...
                this.initiative = 4 + this.attacker.getRNG()
                    .nextInt(7);
    ...
    public void updateTask() {
        ...
        if ((this.longMemory || this.attacker.getEntitySenses()
            ...
            this.initiative = failedPathFindingPenalty + 4
                + this.attacker.getRNG()
                    .nextInt(7);
