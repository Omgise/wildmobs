...
public class EntityAIAvoidEntityWild extends EntityAIBase {
    ...
    public final IEntitySelector selector = new IEntitySelector() {
        ...
        public boolean isEntityApplicable(Entity e) {
            return e.isEntityAlive() && EntityAIAvoidEntityWild.this.theEntity.getEntitySenses()
                .canSee(e);
        }
    };
    ...
    public EntityAIAvoidEntityWild(EntityCreature creature, Class targetClass, float distance, double farSpeed,
        double nearSpeed) {
        ...
        if (((EntityDeer) this.theEntity).getTamed() == false) {
            if (this.targetEntityClass == EntityPlayer.class) {
                ...
                this.closestLivingEntity = this.theEntity.worldObj
                    .getClosestPlayerToEntity(this.theEntity, (double) this.distanceFromEntity);
            ...
            if (vec3 == null || (this.closestLivingEntity.getDistanceSq(vec3.xCoord, vec3.yCoord, vec3.zCoord)
    ...
    public void updateTask() {
        this.theEntity.getNavigator()
            .setSpeed(
                this.theEntity.getDistanceSqToEntity(this.closestLivingEntity) < 49.0D ? this.nearSpeed
                    : this.farSpeed);
    }
}
