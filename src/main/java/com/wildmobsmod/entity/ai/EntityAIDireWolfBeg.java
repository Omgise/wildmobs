...
public class EntityAIDireWolfBeg extends EntityAIBase {
    ...
    public boolean continueExecuting() {
        return !this.thePlayer.isEntityAlive() ? false
            : (this.theWolf.getDistanceSqToEntity(this.thePlayer)
                > (double) (this.minPlayerDistance * this.minPlayerDistance) ? false
                    : this.initiative > 0 && this.hasPlayerGotBoneInHand(this.thePlayer));
    }
    ...
    public void startExecuting() {
        ...
        this.initiative = 40 + this.theWolf.getRNG()
            .nextInt(40);
    }
    ...
    private boolean hasPlayerGotBoneInHand(EntityPlayer player) {
        ...
        return itemstack == null ? false
            : (!this.theWolf.isTamed() && itemstack.getItem() == WildMobsModItems.thickBone ? true
