...
public class EntityAIEatCrops extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (this.mouse.getRNG()
            .nextInt(25) != 0) return false;
    ...
    public void updateTask() {
        ...
        int j = MathHelper.floor_double(this.mouse.posY);
        int k = MathHelper.floor_double(this.mouse.posZ);
        if (this.world.getBlock(i, j - 1, k) == Blocks.farmland && this.world.getBlock(i, j, k) instanceof IGrowable
            && this.world.getGameRules()
