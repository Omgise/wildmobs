...
public class EntityAIFollowLeaderFaded extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (this.theFaded.getIsLeader() == true || this.theFaded.getAttackTarget() != null) {
            ...
            List list = this.theFaded.worldObj
                .getEntitiesWithinAABB(this.theFaded.getClass(), this.theFaded.boundingBox.expand(8.0D, 4.0D, 8.0D));
    ...
    public void updateTask() {
        ...
        if (--this.cooldown <= 0) {
            this.cooldown = 10;
            this.theFaded.getNavigator()
                .tryMoveToEntityLiving(this.theLeaderFaded, this.speedTowardsTarget);
        }
    }
}
