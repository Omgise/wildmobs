...
public class EntityAISkeletonWolfNearestAttackableTarget extends EntityAITarget {
    ...
    public EntityAISkeletonWolfNearestAttackableTarget(EntitySkeletonWolf wolf, Class targetClass, int chance,
        boolean checkSight) {
    ...
    public EntityAISkeletonWolfNearestAttackableTarget(EntitySkeletonWolf wolf, Class targetClass, int chance,
        boolean checkSight, boolean nearbyOnly, final IEntitySelector selector) {
        ...
        this.targetEntitySelector = new IEntitySelector() {
            ...
            public boolean isEntityApplicable(Entity e) {
                return !(e instanceof EntityLivingBase) ? false
                    : (selector != null && !selector.isEntityApplicable(e) ? false
                        : EntityAISkeletonWolfNearestAttackableTarget.this
                            .isSuitableTarget((EntityLivingBase) e, false));
            }
        };
    }
    ...
    public boolean shouldExecute() {
        if (this.targetChance > 0 && this.taskOwner.getRNG()
            .nextInt(this.targetChance) != 0 || ((EntitySkeletonWolf) this.taskOwner).entityToFollow == null)
            return false;
