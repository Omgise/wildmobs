...
public abstract class EntityLargePredator extends EntityAnimal // Adapted from original EntityCougar
{
    ...
    public void onLivingUpdate() // aggregate aggression towards players less than 8m away and ultimately attack them;
                                 // CAN see invisible players and ignores invulnerable ones
    {
