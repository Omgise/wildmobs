...
public class EntityMired extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
            .setBaseValue(0.9500000238418579D);
    ...
    protected void attackEntity(Entity target, float distance) {
        ...
        if (this.attackTime <= 0 && distance < 1.2F
            ...
            if (this.rand.nextInt(2) == 0) {
                ((EntityLivingBase) target)
                    .addPotionEffect(new PotionEffect(Potion.blindness.id, 20 * difficultyFactor, 0));
            }
    ...
    protected void updateEntityActionState() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (this.entityToAttack == null && !this.hasPath()) {
                ...
                i1 = this.worldObj.getBlockMetadata(
                    i + Facing.offsetsXForSide[l1],
                    j + Facing.offsetsYForSide[l1],
                    k + Facing.offsetsZForSide[l1]);
    ...
    public void onLivingUpdate() {
        ...
        if (this.worldObj
            .getBlock(MathHelper.floor_double(this.posX), (int) this.posY, MathHelper.floor_double(this.posZ))
            == Blocks.fire) {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        return !this.worldObj.isRemote && source == DamageSource.inWall ? false
