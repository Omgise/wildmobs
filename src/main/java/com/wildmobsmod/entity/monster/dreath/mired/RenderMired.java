...
public class RenderMired extends RenderLiving {
    ...
    private static final ResourceLocation miredTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/dreath/mired.png");
    ...
    protected void renderEquippedItems(EntityMired mired, float p_77029_2_) {
        ...
        if (itemstack != null) {
            ...
            if (itemstack.getItem() instanceof ItemBlock && RenderBlocks.renderItemIn3d(
