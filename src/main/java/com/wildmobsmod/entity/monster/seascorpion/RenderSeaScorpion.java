...
public class RenderSeaScorpion extends RenderLiving {
    ...
    private static final ResourceLocation seaScorpionTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/sea_scorpion.png");
    ...
    protected void rotateCorpse(EntitySeaScorpion seaScorpion, float f1, float f2, float f3) {
        float f4 = seaScorpion.prevSeaScorpionPitch
            + (seaScorpion.seaScorpionPitch - seaScorpion.prevSeaScorpionPitch) * f3;
