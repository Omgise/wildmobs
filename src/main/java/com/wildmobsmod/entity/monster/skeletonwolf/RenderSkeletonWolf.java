...
public class RenderSkeletonWolf extends RenderLiving {
    ...
    private static final ResourceLocation skeletonWolfTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_skeleton.png");
    private static final ResourceLocation witherSkeletonWolfTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wither_wolf_skeleton.png");
