...
public class ModelWizard extends ModelVillager {
    ...
    public ModelWizard(float scale) {
        ...
        modelrenderer1.setTextureOffset(0, 87)
        ...
        modelrenderer2.setTextureOffset(0, 95)
            .addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.25F);
