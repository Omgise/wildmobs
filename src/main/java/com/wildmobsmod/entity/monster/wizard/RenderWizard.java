...
public class RenderWizard extends RenderLiving {
    ...
    private static final ResourceLocation wizardTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wizard/wizard.png");
    private static final ResourceLocation voldemortTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wizard/voldemort.png");
    ...
    protected void renderEquippedItems(EntityLiving living, float partialTickTime) {
        ...
        if (entitywizard.getHasArms() == false) {} else {
