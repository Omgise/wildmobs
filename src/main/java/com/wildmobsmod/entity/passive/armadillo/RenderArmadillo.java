...
public class RenderArmadillo extends RenderLiving {
    ...
    private static final ResourceLocation armadilloTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/armadillo/armadillo.png");
    private static final ResourceLocation armadilloBallTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/armadillo/armadillo_ball.png");
