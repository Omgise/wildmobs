...
public class ModelCheetah extends ModelBase {
    ...
    public void setLivingAnimations(EntityLivingBase living, float f1, float f2, float f3) {
        EntityCheetah entitycheetah = (EntityCheetah) living;

        this.body1.rotationPointY = 13.0F;
        this.body2.rotationPointY = 13.0F;
        this.head.rotationPointY = 11.4F;
        this.tail.rotationPointY = 10.0F;
        this.leg1.rotationPointY = 14.0F;
        this.leg2.rotationPointY = 14.0F;
        this.leg3.rotationPointY = 14.0F;
        this.leg4.rotationPointY = 14.0F;

        if (entitycheetah.isSneaking()) {
            this.body1.rotationPointY += 3.0F;
            this.body2.rotationPointY += 3.0F;
            if (this.isChild) {
