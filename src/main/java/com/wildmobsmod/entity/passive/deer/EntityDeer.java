...
public class EntityDeer extends EntityRideable implements ISkinnedEntity {
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (super.interact(player)) {
            ...
            && (this.riddenByEntity == null || this.riddenByEntity == player)) {
            ...
            } else if (itemstack != null && (!this.getSaddled())
                ...
                && this.getTamed()) {
                    ...
                    return true;
                } else if (itemstack != null && itemstack.getItem() == Items.wheat
                    && this.getGrowingAge() >= 0
                    && !this.getTamed()
        ...
        if (itemstack != null
            && (itemstack.getItem() == WildMobsModItems.deerSpawnEgg
                || itemstack.getItem() == WildMobsModItems.reindeerSpawnEgg
                || itemstack.getItem() == WildMobsModItems.elkSpawnEgg)
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return this.getTamed() && stack != null && stack.getItem() == Items.wheat; // currently only breedable when
                                                                                   // tamed
    }
