...
public class RenderDeer extends RenderLiving {
    ...
    private static final ResourceLocation whitetailTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/deer/deer_whitetail.png");
    private static final ResourceLocation reindeerTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/deer/deer_reindeer.png");
    private static final ResourceLocation rudolphTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/deer/deer_rudolph.png");
    private static final ResourceLocation elkTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/deer/deer_elk.png");
    private static final ResourceLocation saddledTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/deer/deer_saddle.png");
