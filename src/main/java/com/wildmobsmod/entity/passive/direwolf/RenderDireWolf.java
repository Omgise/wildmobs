...
public class RenderDireWolf extends RenderLiving {
    ...
    private static final ResourceLocation direWolfTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/direwolf/direwolf.png");
    private static final ResourceLocation tamedDireWolfTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/direwolf/direwolf_tame.png");
    private static final ResourceLocation anrgyDireWolfTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/direwolf/direwolf_angry.png");
    private static final ResourceLocation direWolfCollarTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/direwolf/direwolf_collar.png");
    ...
    protected ResourceLocation getEntityTexture(EntityDireWolf direwolf) {
        return direwolf.isTamed() ? tamedDireWolfTextures
            : (direwolf.isAngry() ? anrgyDireWolfTextures : direWolfTextures);
    }
