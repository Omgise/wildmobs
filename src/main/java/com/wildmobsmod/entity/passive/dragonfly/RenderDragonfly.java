...
public class RenderDragonfly extends RenderLiving {
    ...
    private static final ResourceLocation blueTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/dragonfly/dragonfly_blue.png");
    private static final ResourceLocation cyanTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/dragonfly/dragonfly_cyan.png");
    private static final ResourceLocation greenTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/dragonfly/dragonfly_green.png");
    private static final ResourceLocation orangeTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/dragonfly/dragonfly_orange.png");
    private static final ResourceLocation redTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/dragonfly/dragonfly_red.png");
    private static final ResourceLocation yellowTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/dragonfly/dragonfly_yellow.png");
    ...
    protected ResourceLocation getEntityTexture(EntityDragonfly dragonfly) {
        int type = dragonfly.getDataWatcher()
            .getWatchableObjectByte(20);
        switch (dragonfly.getDataWatcher()
            .getWatchableObjectByte(20)) {
            case 0:
                return blueTextures;
            case 1:
