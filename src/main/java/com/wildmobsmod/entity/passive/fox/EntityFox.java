...
public class EntityFox extends EntityAnimal implements ISkinnedEntity {
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (super.interact(player)) {
            ...
            if (itemstack != null && (itemstack.getItem() == WildMobsModItems.foxSpawnEgg
                || itemstack.getItem() == WildMobsModItems.arcticFoxSpawnEgg
                || itemstack.getItem() == WildMobsModItems.desertFoxSpawnEgg)) {
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        if (biome.getEnableSnow()) {
            this.setSkin(1);
        } else if (Arrays.asList(BiomeDictionary.getTypesForBiome(worldObj.getBiomeGenForCoords(i, j)))
