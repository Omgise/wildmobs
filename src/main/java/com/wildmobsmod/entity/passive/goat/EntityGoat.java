...
public class EntityGoat extends EntityAnimal implements ISkinnedEntity {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
            .setBaseValue(0.17000000298023224D);
    }
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.bucket && !player.capabilities.isCreativeMode) {
            if (itemstack.stackSize-- == 1) {
                player.inventory
                    .setInventorySlotContents(player.inventory.currentItem, new ItemStack(Items.milk_bucket));
            ...
            if (itemstack != null && itemstack.getItem() == Items.gold_ingot && !player.capabilities.isCreativeMode) {
                itemstack.stackSize--;
                ...
                return false;
            } else if (itemstack != null && itemstack.getItem() == WildMobsModItems.goatSpawnEgg
