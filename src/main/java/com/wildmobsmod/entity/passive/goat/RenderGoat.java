...
public class RenderGoat extends RenderLiving {
    ...
    private static final ResourceLocation whiteTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/goat/goat_white.png");
    private static final ResourceLocation brownTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/goat/goat_brown.png");
    private static final ResourceLocation grayTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/goat/goat_gray.png");
    private static final ResourceLocation splotchedTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/goat/goat_splotched.png");
