...
public class EntityConfigHyena extends EntityConfig {
     ...
     * method.
     */
    public static EntityConfigHyena construct(String id, int spawnrate, int minPack, int maxPack, boolean enabled,
        boolean attackPlayersAtNight) {
    ...
    protected EntityConfigHyena(String id, int defaultSpawnrate, int defaultMinPack, int defaultMaxPack,
        boolean defaultEnabled, boolean defaultAttackPlayersAtNight) {
    ...
    protected void sync(Configuration config) {
        super.sync(config);
        attackPlayersAtNight = config.getBoolean(
            "attackPlayersAtNight",
            getConfigCategory(),
            defaultAttackPlayersAtNight,
            "Allow Hyenas to attack nearby Players at night in non-peaceful worlds?");
    }
