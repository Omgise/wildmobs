...
public class EntityHyena extends EntityLargePredator {
    ...
    public EntityHyena(World world) {
        ...
        targetTasks.addTask(
            5,
            new EntityAINocturnalActions(
                this,
                new EntityAINearestAttackableTarget(this, EntityVillager.class, 500, true),
                NOCTURNAL_LIGHTLEVEL,
                true));
    }
    ...
    {
        return WildMobsMod.HYENA_CONFIG.getAttackPlayersAtNight()
            && worldObj.difficultySetting != EnumDifficulty.PEACEFUL
            && getBrightness(1.0F) < NOCTURNAL_LIGHTLEVEL
                ? worldObj.getClosestVulnerablePlayerToEntity(this, INTRUDER_RANGE)
                : null;
    }
