...
public class RenderHyena extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/hyena/hyena.png");
    private static final ResourceLocation cubTexture = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/hyena/hyena_cub.png");
