...
public class RenderJellyfish extends RenderLiving {
    ...
    private static final ResourceLocation orangeTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/jellyfish/jellyfish_orange.png");
    private static final ResourceLocation blueTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/jellyfish/jellyfish_blue.png");
    private static final ResourceLocation pinkTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/jellyfish/jellyfish_pink.png");
    private static final ResourceLocation redTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/jellyfish/jellyfish_red.png");
    private static final ResourceLocation yellowTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/jellyfish/jellyfish_yellow.png");
    private static final ResourceLocation whiteTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/jellyfish/jellyfish_white.png");
    private static final ResourceLocation netherTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/jellyfish/jellyfish_nether.png");
    ...
    protected ResourceLocation getEntityTexture(EntityJellyfish jellyfish) {
        int type = jellyfish.getDataWatcher()
