...
public class EntityConfigMouse extends EntityConfig {
     ...
     * method.
     */
    public static EntityConfigMouse construct(String id, int spawnrate, int minPack, int maxPack, boolean enabled,
        boolean enableDiseasedMouse) {
    ...
    protected EntityConfigMouse(String id, int defaultSpawnrate, int defaultMinPack, int defaultMaxPack,
        boolean defaultEnabled, boolean defaultEnableDiseasedMouse) {
    ...
    protected void sync(Configuration config) {
        super.sync(config);
        enableDiseasedMouse = config.getBoolean(
            "enableDiseasedMouse",
            getConfigCategory(),
            defaultEnableDiseasedMouse,
            "Enable diseased/ill mice?");
    }
