...
public class RenderWMOcelot extends RenderLiving {
    ...
    private static final ResourceLocation tabbyOcelotTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/cat/tabby.png");
    private static final ResourceLocation grayOcelotTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/cat/gray.png");
    private static final ResourceLocation whiteOcelotTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/cat/white.png");
