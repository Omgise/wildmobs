...
public class RenderWMWolf extends RenderLiving {
    ...
    private static final ResourceLocation tamedWolfArcticTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_arctic.png");
    private static final ResourceLocation tamedWolfHuskyTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_husky.png");
    private static final ResourceLocation tamedWolfBerneseTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_bernese.png");
    private static final ResourceLocation tamedWolfBlackTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_black.png");
    private static final ResourceLocation tamedWolfBrownTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_brown.png");
    private static final ResourceLocation tamedWolfDalmatianTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_dalmatian.png");
    private static final ResourceLocation tamedWolfHoundTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_hound.png");
    private static final ResourceLocation tamedWolfPointerTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_pointer.png");
    private static final ResourceLocation tamedWolfShepherdTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_shepherd.png");
    private static final ResourceLocation tamedWolfShibaTextures = new ResourceLocation(
        WildMobsMod.MODID + ":textures/entity/wolf/wolf_tame_shiba.png");
    ...
    protected ResourceLocation getEntityTexture(EntityWMWolf wolf) {
        switch (wolf.getSkin()) {
            ...
            case 0:
            default:
                return wolf.isTamed() ? tamedWolfTextures : wolf.isAngry() ? anrgyWolfTextures : wolfTextures;
        }
    }
