...
public class EntityLavaSpit extends EntityThrowable {
    ...
    public void onUpdate() {
        if (this.worldObj.isRemote) {
            for (int i = 0; i < 2; ++i) {
                ClientProxy.generateEntityMagmaSpitFX(
                    this,
                    this.posX,
                    this.posY,
                    this.posZ,
                    this.worldObj.rand.nextGaussian() * 0.01D,
                    this.worldObj.rand.nextGaussian() * 0.01D,
                    this.worldObj.rand.nextGaussian() * 0.01D);
            ...
            if (pos.entityHit != null) {
                ...
                if (power > 0) {
                    if (!pos.entityHit.isImmuneToFire()) {
                        pos.entityHit
                            .attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), (float) power);
                    }
