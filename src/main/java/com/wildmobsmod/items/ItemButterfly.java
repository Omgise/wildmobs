...
public class ItemButterfly extends ItemWM {

    public static final String[] variants = new String[] { "beige", "blue", "glass", "lime", "orange", "purple", "red",
        "white", "yellow", "cyan", "brown", "black", "green", "gray" };
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        EntityButterfly entityliving = new EntityButterfly(world);
