...
public class WildMobsModItems {
    ...
    public static ArmorMaterial enumArmorMaterialFur = EnumHelper
        .addArmorMaterial("WILDMOBS_FUR", 5, new int[] { 1, 3, 2, 1 }, 15);
    public static ArmorMaterial enumArmorMaterialBisonLeather = EnumHelper
        .addArmorMaterial("WILDMOBS_BISON_LEATHER", 5, new int[] { 1, 3, 2, 1 }, 15);
    ...
    public static final Item reindeerSpawnEgg = new ItemWildMobsMonsterPlacer(
        "Deer",
        0xD1BCAE,
        0x7D624F,
        1,
    ...
    public static final Item arcticFoxSpawnEgg = new ItemWildMobsMonsterPlacer(
        "Fox",
        0xEEEEE4,
        0xB0B0B0,
        1,
        false,
        "ArcticFox");
    public static final Item desertFoxSpawnEgg = new ItemWildMobsMonsterPlacer(
        "Fox",
        0xD9A871,
        0xB08D66,
        2,
    ...
    // public static final Item wizardSpawnEgg = new ItemWildMobsMonsterPlacer("Wizard", 0x4F5678, 0xB5A59B, 0, false);
    // //disabled for now
    public static final Item mouseSpawnEgg = new ItemWildMobsMonsterPlacer("Mouse", 0x7A6858, 0xEDA8A8, 0, false);
    public static final Item butterflySpawnEgg = new ItemWildMobsMonsterPlacer(
        "Butterfly",
        0xCC5621,
        0xEFD71F,
        0,
        false);
    public static final Item tarantulaSpawnEgg = new ItemWildMobsMonsterPlacer(
        "Tarantula",
        0x1A1812,
        0xA30F0F,
        0,
    ...
    public static final Item magmaPlantSpawnEgg = new ItemWildMobsMonsterPlacer(
        "MagmaPlant",
        0x9F452B,
        0xF5835D,
        0,
        false);
    public static final Item dragonflySpawnEgg = new ItemWildMobsMonsterPlacer(
        "Dragonfly",
        0x616BBA,
        0xF0D737,
        0,
        false);
    public static final Item armadilloSpawnEgg = new ItemWildMobsMonsterPlacer(
        "Armadillo",
        0xB5AEAC,
        0xBCA593,
        0,
        false);
    public static final Item jellyfishSpawnEgg = new ItemWildMobsMonsterPlacer(
        "Jellyfish",
        0xF5A51B,
        0xBD4707,
        0,
        false);
    public static final Item netherJellyfishSpawnEgg = new ItemWildMobsMonsterPlacer(
        "Jellyfish",
        0xA63719,
        0xF5A51B,
        6,
        true,
        "NetherJellyfish");
    public static final Item skeletonWolfSpawnEgg = new ItemWildMobsMonsterPlacer(
        "SkeletonWolf",
        0xC4A68F,
        0x737373,
        0,
    ...
    public static final Item wildCatSpawnEgg = new ItemWildMobsMonsterPlacer(
        "WMOcelot",
        0x807B78,
        0xFFFFFF,
        1,
    ...
    public static final Item seaScorpionSpawnEgg = new ItemWildMobsMonsterPlacer(
        "SeaScorpion",
        0xA2AD57,
        0x615A1F,
        0,
    ...
    public static void initItems() {
        // Armor
        helmetBison = new ItemWMArmor(
            enumArmorMaterialBisonLeather,
            5,
            0,
            "wildmobsmod:bison_helmet",
            "wildmobsmod:textures/models/armor/bison_layer_1.png").setUnlocalizedName("bison_leather_helmet");
        chestplateBison = new ItemWMArmor(
            enumArmorMaterialBisonLeather,
            5,
            1,
            "wildmobsmod:bison_chestplate",
            "wildmobsmod:textures/models/armor/bison_layer_1.png").setUnlocalizedName("bison_leather_chestplate");
        legsBison = new ItemWMArmor(
            enumArmorMaterialBisonLeather,
            5,
            2,
            "wildmobsmod:bison_leggings",
            "wildmobsmod:textures/models/armor/bison_layer_2.png").setUnlocalizedName("bison_leather_leggings");
        bootsBison = new ItemWMArmor(
            enumArmorMaterialBisonLeather,
            5,
            3,
            "wildmobsmod:bison_boots",
            "wildmobsmod:textures/models/armor/bison_layer_1.png").setUnlocalizedName("bison_leather_boots");
        helmetFur = new ItemWMArmor(
            enumArmorMaterialFur,
            5,
            0,
            "wildmobsmod:fur_helmet",
            "wildmobsmod:textures/models/armor/fur_layer_1.png").setUnlocalizedName("fur_helmet");
        chestplateFur = new ItemWMArmor(
            enumArmorMaterialFur,
            5,
            1,
            "wildmobsmod:fur_chestplate",
            "wildmobsmod:textures/models/armor/fur_layer_1.png").setUnlocalizedName("fur_chestplate");
        legsFur = new ItemWMArmor(
            enumArmorMaterialFur,
            5,
            2,
            "wildmobsmod:fur_leggings",
            "wildmobsmod:textures/models/armor/fur_layer_2.png").setUnlocalizedName("fur_leggings");
        bootsFur = new ItemWMArmor(
            enumArmorMaterialFur,
            5,
            3,
            "wildmobsmod:fur_boots",
            "wildmobsmod:textures/models/armor/fur_layer_1.png").setUnlocalizedName("fur_boots");
        ...
        roastedMagmaPlantSeed = ((ItemFood) new ItemWMFood(2, 0.5F, false).setInternalName("roasted_magma_plant_seed"))
            .setPotionEffect(Potion.fireResistance.id, 300, 0, 1F)
            .setAlwaysEdible();
    ...
    public static void registerItems() {
        ...
        GameRegistry.registerItem(cougarHide, "cougar_hide"); // this doesn't have a use right now, generic fur is
                                                              // dropped (with the exception of bisons)
