        ...
        public LoadedDice(double[] probabilities, Random random) {
            ...
            if (size == 0) {
                throw new IllegalArgumentException(
                    "Cannot create a 0-sided dice! (probability array may not be empty)");
            }
            ...
            probabilities = probabilities.clone(); // protect the source array from changes; cloning is safe on
                                                   // primitive arrays
